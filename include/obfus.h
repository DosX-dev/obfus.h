...
static char _s_a[] = "a", _s_b[] = "b", _s_c[] = "c", _s_d[] = "d",
...
#define scanf(...) callfunc(getScanfName_Proxy(), __VA_ARGS__)
...
#define sprintf(...) callfunc(getSprintfName_Proxy(), __VA_ARGS__)
...
#define fclose(...) callfunc(getSprintfName_Proxy(), __VA_ARGS__)
